module mips(
    ...
    wire [31:0] R_data_dm;
    // IM wires
    wire [11:2] addr_im = pc[9:0];//###############
    // MUX_3_data wires
    wire [31:0] pc_plus_4 = pc + 4;
    wire [31:0] alu_result = result;
    wire [31:0] data_from_DM;
    wire [31:0] write_to_GPR = W_data;
    // MUX_3_num wires
    wire [4:0] rt;
    wire [4:0] rd;
    ...
    MUX_3_num mux_3_num_inst(.s_num_write(s_num_write), .rt(full_instr[20:16]), .rd(full_instr[15:11]), .W_addr(W_addr));
